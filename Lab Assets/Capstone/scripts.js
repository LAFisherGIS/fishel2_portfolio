    ...
    let epJson = L.geoJson(elemPoints, {
      pointToLayer: function(feature, latlng){
        ...
        risk = feature.properties.OverPol14;
          ...
          marker.bindPopup("Name: " + feature.properties.ShortName + "<br>" + "<br>2014 Pollution Model Score: " + " " + feature.properties.OverPol14.toFixed(3)  + "<br>" + "<br>2015 Pollution Model Score: " + " " + feature.properties.OverPol15.toFixed(3) + "<br>2014 Disadvantage Index: " + " " + feature.properties.OverDisA14 + "<br> 2015 Disadvantage Index: " + " " + feature.properties.OverDisA15 + "<br> 2014 Reading Score (0 = Best): " + " " + feature.properties.r14_over + "<br> 2015 Reading Score (0 = Best): " + " " + feature.properties.r15_over + "<br> 2014 Math Score (0 = Best): " + " " + feature.properties.m14_over + "<br> 2015 Math Score (0 = Best): " + " " + feature.properties.m15_over + "<br>2014 Title I Eligibility (1 = Yes): " + " " + feature.properties.y14_TI +   "<br>2015 Title I Eligibility: " + " " + feature.properties.y15_TI +  "<br>2014 Free/Reduced Lunch Eligibility (Decimal Percentage of Students): " + " " + feature.properties.y14_LuPer + "<br>2015 Free/Reduced Lunch Eligibility (Decimal Percentage of Students): " + " " + feature.properties.y15_LuPer + "<br>2014 Latinx Students (Decimal Percentage of Students): " + " " + feature.properties.y14_LaPer + "<br>2015 Latinx Students (Decimal Percentage of Students): " + " " + feature.properties.y15_LaPer + "<br>2014 Native American Students (Decimal Percentage of Students): " + " " + feature.properties.y14_NaPer + "<br>2015 Native American Students (Decimal Percentage of Students): " + " " + feature.properties.y15_NaPer + "<br>2014 Black Students (Decimal Percentage of Students): " + " " + feature.properties.y14_BlPer + "<br>2015 Black Students (Decimal Percentage of Students): " + " " + feature.properties.y15_BlPer + "<br>2014 Pacific Islander Students (Decimal Percentage of Students): " + " " + feature.properties.y14_PaPer + "<br>2015 Pacific Islander Students (Decimal Percentage of Students): " + " " + feature.properties.y15_PaPer)
          return marker;
        }
    });
